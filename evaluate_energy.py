...
if __name__ == "__main__":
    ...
    print("\n--- 2. Evaluating AI-Powered (Proactive) Energy Agent ---")
    ai_predictor = MockEnergyPredictor()
    ...
    # --- 3. Final Results ---
    print("\n--- 📊 Energy Management Evaluation Complete ---")
    print("Comparing average reward per step (higher is better, less negative = lower cost)\n")
    ...
    # Calculate improvement. Since rewards are negative, a smaller negative is better.
    improvement = ((ai_reward - baseline_reward) / abs(baseline_reward)) * 100
    print(f"\nResult: The AI-Powered agent performed {improvement:.2f}% better (lower cost).")